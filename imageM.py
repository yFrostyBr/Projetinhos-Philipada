...
class Image:
    def __init__(self,x_pixels=0, y_pixels = 0, num_channels=0, filename=''):
        ...
        if x_pixels and y_pixels and num_channels:
            ...
            self.x_pixels, self.y_pixels, num_channels = self.array.shape
        else:
            raise ValueError("Você prescisa inserir o nome de um arquivo ou especificar as dimensões da imagem")
